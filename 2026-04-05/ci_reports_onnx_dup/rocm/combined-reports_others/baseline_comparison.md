...
|---|---|---|---|---|---|---|
|migraphx_torchvision__resnet50i64|PASS|within tol|12.7626|12.6755|-0.0871|-0.68%|

## 30 Regressions Found:

|model name|old_status|new_status|
|---|---|---|
|flaubert_Opset18_transformers|Numerics|setup|
...
|seresnext50_32x4d_vaiq|PASS|Numerics|

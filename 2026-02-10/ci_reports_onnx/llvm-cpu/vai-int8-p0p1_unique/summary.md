...
| IREE Compilation | 427 | 100.0% | 100.0% |
| Gold Inference | 427 | 100.0% | 100.0% |
| IREE Inference Invocation | 427 | 100.0% | 100.0% |
| Inference Comparison (PASS) | 363 | 85.0% | 85.0% |
## Fail Summary
...
| Inference Comparison | 64 | 15.0% |
## Test Run Detail
Test was run with the following arguments:
Namespace(sources=['./e2eamdshark-reports/ci_reports_llvm-cpu_vai-int8-p0p1-shard1_unique_onnx_json/vai-int8-p0p1-shard1_unique.json', './e2eamdshark-reports/ci_reports_llvm-cpu_vai-int8-p0p1-shard2_unique_onnx_json/vai-int8-p0p1-shard2_unique.json', './e2eamdshark-reports/ci_reports_llvm-cpu_vai-int8-p0p1-shard3_unique_onnx_json/vai-int8-p0p1-shard3_unique.json'], output='./e2eamdshark-reports/vai-int8-p0p1_unique.json', report=True, report_file='./e2eamdshark-reports/vai-int8-p0p1_unique.md')
